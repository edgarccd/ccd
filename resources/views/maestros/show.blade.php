<x-app-layout>
    <br>
    <div class="card col-3" style="margin:auto;">
        <br>
        <h3 class="text-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                class="bi bi-person-fill" viewBox="0 0 16 16">
                <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
            </svg> Datos del Maestro
        </h3>
        <div class="card-body text-center">
            <img src="/images/nofoto.jpg" class="card-img-top" style="width: 60%;">
            <h3 class="card-title"> {{ $maestro->apellido_pat }} {{ $maestro->apellido_mat }} <br> {{ $maestro->nombre }}</h3>            
        </div>
        <ul class="list-group list-group-flush">
            <li class="list-group-item">
                <h5><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
