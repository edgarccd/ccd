            ...
            <ul class="navbar-nav">
                ...
                @if (Auth::user()->tipo_id == 7)
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="{{ route('proyectos.catalogo') }}"> <svg
                                    ...
                                    </svg> Catálogo Disponible</a>
                            </li>
                            <li><a class="dropdown-item" href="{{ route('proyectos.evaluar', Auth::user()) }}"> <svg
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    ...
                                    </svg> Evaluación de Proyectos</a>
                            </li>
                            <li><a class="dropdown-item" href="{{ route('equipos.index', Auth::user()) }}"> <svg
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                ...
                @if (Auth::user()->tipo_id == 3)
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('proyectos.catalogoCompleto') }}"> <svg
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="currentColor" class="bi bi-card-list" viewBox="0 0 16 16">
                                        <path
                                            d="M14.5 3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2z" />
                            ...
                            <li><a class="dropdown-item" href="{{ route('horarios.index', Auth::user()) }}"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            ...
                            <li><a class="dropdown-item" href="{{ route('equipos.registrados', Auth::user()) }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
