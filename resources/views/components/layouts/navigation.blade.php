            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="/pdf/horarios2024C.pdf" target="_blank"> <svg
                        ...
                        <li><a class="dropdown-item" href="/pdf/normativa.pdf" target="_blank"> <svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <li><a class="dropdown-item" href="/pdf/entregables_matutino.pdf" target="_blank"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-check-fill" viewBox="0 0 16 16">
                        ...
                        <li><a class="dropdown-item" href="/pdf/entregables_vespertino.pdf"
                                target="_blank"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-check-fill" viewBox="0 0 16 16">
                                    <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0M9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1m1.354 4.354-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 9.793l2.646-2.647a.5.5 0 0 1 .708.708"/>
                                  </svg> Vespertino</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="#" > <svg
                                ...
                                </svg> Video de Introducción</a></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li><a class="dropdown-item" href="/pdf/interactic2024.pdf" target="blank"> <svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                ...
                                </svg> Agenda de Actividades</a></li>

                        <li><a class="dropdown-item" href="/pdf/interacticCA2024.pdf" target="blank"> <svg
                        ...
                        <li><a class="dropdown-item" href="#" > <svg
                                ...
                                </svg> Concurso de Personaje</a></li>
                    </ul>
                </li>

                <li class="nav-item">
                    <a class="nav-link"
                        href="https://transparencia.info.jalisco.gob.mx/sites/default/files/AVISO%20DE%20PRIVACIDAD%20UTJ.pdf"
